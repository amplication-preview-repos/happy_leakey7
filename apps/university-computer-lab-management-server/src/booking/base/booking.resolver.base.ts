...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        computer: args.data.computer
          ? {
              connect: args.data.computer,
            }
          : undefined,
  ...
  async getComputer(
    ...
    const result = await this.service.getComputer(parent.id);
  ...
  async getStudent(@graphql.Parent() parent: Booking): Promise<Student | null> {
